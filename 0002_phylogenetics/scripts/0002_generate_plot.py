...
RCODE = (
    ...
    '  theme(axis.text.y = element_text(family=my_family, colour = "black", size = rel(1)*my_size_ratio)) + \n'
    '  theme(axis.text.x = element_text(family=my_family, colour = "black", size = rel(1)*my_size_ratio)) + \n'
